import 'package:yash_s_application3/presentation/dashboard_screen/widgets/doctor_item_widget.dart';
import 'package:yash_s_application3/presentation//dashboard_screen/widgets/eighteen_item_widget.dart';
...
import 'package:yash_s_application3/widgets/app_bar/appbar_title.dart';
...
import 'package:yash_s_application3/widgets/station_custom_bottom_bar.dart';
...
class StationDashboardScreen extends StatelessWidget {
  StationDashboardScreen({Key? key}) : super(key: key);
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        height: 74.v,
        title: AppbarTitle(
            text: "Welcome to CopMap", margin: EdgeInsets.only(left: 20.h)),
        actions: [
          AppbarTrailingImage(
  ...
  Widget _buildTopDoctorSeeAll(BuildContext context) {
    return Padding(
        ...
        child: Row(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text("Top Officer", style: theme.textTheme.titleMedium),
              GestureDetector(
                  onTap: () {
  ...
  Widget _buildHealtArticleSee(BuildContext context) {
    return Padding(
        ...
        child:
          ...
          Text("Todays Article", style: theme.textTheme.titleMedium),
          GestureDetector(
              onTap: () {
  ...
  Widget _buildTwentyFour(BuildContext context) {
    return Container(
        ...
        child: Row(
            ...
            children: [
              CustomImageView(
                  imagePath: 'assets/images/article2.webp',
                  height: 55.adaptSize,
                  width: 55.adaptSize,
                  ...
                  child: Column(
                      ...
                      children: [
                        SizedBox(
                            width: 179.h,
                            child: Text(
                                "Ganesh Visarjan: 20k cops on bandobast duty in Mumbai today",
                                maxLines: 2,
                                overflow: TextOverflow.ellipsis,
  ...
  String getCurrentRoute(BottomBarEnum type) {
    switch (type) {
      ...
      case BottomBarEnum.Create:
        return AppRoutes.stationDashboardScreen;
  ...
  Widget getCurrentPage(String currentRoute) {
    switch (currentRoute) {
      ...
      case AppRoutes.stationCreateScreen:
        return StationCreateScreen();
      case AppRoutes.stationDashboardScreen:
